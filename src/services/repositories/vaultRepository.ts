...
/** 演示 Vault 播种文件（与 tests/fixtures/obsidian-vault 同源，?raw 导入） */
import ragMd from '../../../tests/fixtures/obsidian-vault/AI/RAG.md?raw';
import embeddingMd from '../../../tests/fixtures/obsidian-vault/AI/Embedding.md?raw';
import milvusMd from '../../../tests/fixtures/obsidian-vault/AI/Milvus.md?raw';
import llmMd from '../../../tests/fixtures/obsidian-vault/AI/LLM.md?raw';
import agentMd from '../../../tests/fixtures/obsidian-vault/AI/Agent.md?raw';
import transformerMd from '../../../tests/fixtures/obsidian-vault/AI/Transformer.md?raw';
import jvmMd from '../../../tests/fixtures/obsidian-vault/Java/JVM 内存结构.md?raw';
import g1Md from '../../../tests/fixtures/obsidian-vault/Java/G1 垃圾回收器.md?raw';
import gcRootsMd from '../../../tests/fixtures/obsidian-vault/Java/GC Roots.md?raw';
import concurrentMd from '../../../tests/fixtures/obsidian-vault/Java/并发编程.md?raw';
import casMd from '../../../tests/fixtures/obsidian-vault/Java/CAS.md?raw';
import springMd from '../../../tests/fixtures/obsidian-vault/Java/Spring IOC 与 AOP.md?raw';
import projectMd from '../../../tests/fixtures/obsidian-vault/Projects/ObsidianMind.md?raw';
import readingMd from '../../../tests/fixtures/obsidian-vault/01-个人成长/读书笔记方法.md?raw';
...
class VaultRepository {
  ...
  async scan(onProgress?: (found: number) => void): Promise<ScanSummary> {
    ...
    this.lastScanPaths = new Map([...files.entries()].map(([p, m]) => [p, m.modifiedAt]));
